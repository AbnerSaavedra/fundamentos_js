...
function obtenerPersonaje(id, callback) {
    ...
    .fail(()=>{
        ...
        console.log(`Ha ocurrido un error. No se pudo obtener el personaje ${id}`) // Para ver los parámetros que recibe la funcion get()

    }) //Si ocurre algún error el metodo fail con su callback se ejecuta
}
